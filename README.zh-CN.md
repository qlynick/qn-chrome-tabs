...
[![npm 版本](https://img.shields.io/npm/v/qn-chrome-tabs?logo=npm&logoColor=white)](https://www.npmjs.com/package/qn-chrome-tabs)
[![每周下载量](https://img.shields.io/npm/dw/qn-chrome-tabs?logo=npm&logoColor=white)](https://www.npmjs.com/package/qn-chrome-tabs)
[![开源协议](https://img.shields.io/npm/l/qn-chrome-tabs?logo=opensourceinitiative&logoColor=white)](./LICENSE)
[![压缩体积](https://img.shields.io/bundlephobia/minzip/qn-chrome-tabs?logo=javascript&logoColor=white)](https://bundlephobia.com/package/qn-chrome-tabs)
[![运行时依赖](https://img.shields.io/badge/runtime_dependencies-0-2ea44f?logo=webassembly&logoColor=white)](./package.json)

零框架依赖的 Chrome 风格标签栏 Web Component。可直接放进普通 HTML，也可以在
Vue、React 或其他前端项目中使用。

[在线 Demo](https://qlynick.github.io/qn-chrome-tabs/) ·
[在 StackBlitz 中编辑](https://stackblitz.com/github/qlynick/qn-chrome-tabs?file=demo%2Fmain.ts&startScript=dev) ·
[GitHub](https://github.com/qlynick/qn-chrome-tabs) ·
[npm](https://www.npmjs.com/package/qn-chrome-tabs) ·
[文档站开发说明](./docs/README.md)

![Qn Chrome Tabs 交互演示](https://raw.githubusercontent.com/qlynick/qn-chrome-tabs/main/assets/qn-chrome-tabs-demo.gif)
...
- 需要 Chrome 风格标签交互的后台管理系统或工作区应用
- 需要在普通 HTML、Vue、React 或微前端之间复用同一组件
- 业务应用自行管理标签与分组数据的受控状态模式
