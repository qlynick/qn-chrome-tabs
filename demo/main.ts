...
const translations: Record<'en' | 'ko', Record<string, string>> = {
  en: {
    ...
    '事件日志': 'Event log',
    '快速上手': 'Quick start',
    '安装后直接注册 Web Component，无需前端框架。': 'Register the Web Component after installation. No framework required.',
    '工作': 'Work', '学习': 'Study',
  ...
  ko: {
    ...
    '快速上手': '빠른 시작',
    '安装后直接注册 Web Component，无需前端框架。': '설치 후 Web Component를 등록하세요. 프레임워크가 필요 없습니다.',
    '工作': '업무', '学习': '학습',
